...
1. Открыть проект (у меня в IntelliJ IDEA 2025.2.1, gson 2.10.1, java version "24.0.2" 2025-07-15), gson: File -> Project Structure -> Modules -> Dependencies,  "+" -> JARs or directories... выбрать скачанный gson-2.10.1.jar, Кликните правой кнопкой мыши по папке 1 внутри term-2 -> Mark Directory as -> Sources Root и повторите для 21 и 3й папки.
