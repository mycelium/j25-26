...
/**
 * Parse un body multipart/form-data en une liste de Part.
 *
 * Utilisation :
 *   String boundary = MultipartParser.extractBoundary(request);
 *   List<Part> parts = MultipartParser.parse(request.getBody(), boundary);
 */
public class MultipartParser {
    ...
    /** Recherche la première occurrence de {@code needle} dans {@code haystack} à partir de {@code from}. */
