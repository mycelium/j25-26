...
```
## Результаты
Результаты выполнения умножения матриц 5 разных размеров классическим и оптимизированным способом представлены в таблице. Тесты проводились с учетом разогрева JVM
...
Из таблицы видно, что оптимизированный подход второй матрицы заметно сокращает время выполнения умножения матриц.
