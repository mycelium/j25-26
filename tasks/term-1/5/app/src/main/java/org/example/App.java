...
public class App {
    public static void main(String[] args) {
        ...
        String filePath = "C:\\Users\\pc\\IdeaProjects\\section\\src\\main\\java\\org\\example\\lab5\\short_reviews.txt";
        File file = new File(args.length > 0 ? args[0] : filePath);
        
        if (!file.exists() && args.length == 0) {
             file = new File("short_reviews.txt");
        }
