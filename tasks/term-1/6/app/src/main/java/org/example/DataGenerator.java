...
public class DataGenerator {
    ...
    /**
    * Генерация данных в виде сетки.
    * @param gridSize - размер сетки (gridSize = 2 создаст 2x2=4 кластера).
    * @param pointsPerCluster - количество точек в каждом кластере.
    * @param clusterSpread - разброс точек внутри кластера.
    * @param clusterDistance - расстояние между центрами кластеров.
    * @return Cписок точек, распределенных в виде сетки.
    */
    ...
    /**
    * Генерация данных "Two Moons".
    * @param pointsPerMoon - количество точек на каждом полумесяце.
    * @param noise - уровень шума.
    * @param moonDistance - расстояние между полумесяцами.
    * @return Список точек в форме двух полумесяцев.
    */
    ...
    * @param numClasses - количество классов.
    * @param totalPoints - общее количество точек.
    * @param fieldSize - размер поля.
    * @return Список полностью случайных точек.
    */
